...
- Remove huge gaps per panel
- Make draggable functions directly in panels edges and
...
- Only show markdown syntax when user touches a specific word 
  sentence or paragraph that the syntax is still covered only 

- Hide the syntax and apply the syntax effect when user closses the operations 
  move to other words or sentence that the syntax didn't covered..
